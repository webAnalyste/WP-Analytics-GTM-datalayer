		...
		<div class="wadl-sections">
			...
			<div class="wadl-section">
				...
				<div class="wadl-toggles">
					...
					$this->toggle( 'event_update_cart',      'update_cart',      'Déclenché après chaque ajout ou suppression AJAX (panier complet : value, quantity, items).', (bool) $settings['event_update_cart'] );
					?>
				</div>
			</div>
